...
https://gamebanana.com/mods/439021
...
1. [Install Haxe 4.2.5](https://haxe.org/download/version/4.2.5/) (Download 4.2.5 instead of 4.3.0 because 4.3.0 is broken and is not working with game...)
...
Once you have all those installed, it's pretty easy to compile the game. You just need to run `lime test android -debug` in the root of the project to build and run the android version.
## The End
